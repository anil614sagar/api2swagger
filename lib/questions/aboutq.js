...
var infoq = [
  { name: 'title',     message: 'Title of Swagger Spec ?', default: 'API Program title goes here..'},
  { name: 'description',     message: 'Description of Swagger Spec ?', default: 'API Program Description goes here..'},
  { name: 'termsOfService', message: 'Terms of Service URL ?', default: 'http://example.com'},
  { name: 'version', message: 'Version of your API Program ?', default: '0.0.1'},
  { name: 'contactName',     message: 'Contact Name?'},
  { name: 'contactUrl',     message: 'Contact URL ?', default: 'http://example.com'},
  { name: 'contactEmail', message: 'Contact Email ?', default: 'example@example.com'},
